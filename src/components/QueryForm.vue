  ...
  <div id="settings">
    ...
    <p>
      ...
      <select id="activity-type" v-model="selectedType">
        ...
        <option v-for="(name, value) in activityTypes" :value="value">
          {{ name }}
        </option>
      </select>
    </p>
    ...
    <p>
      <input
        ...
        v-on:click="$emit('submit', $data)"
      />
    </p>
    <p>
      <input
        type="button"
        value="Clear Shown Activities"
    ...
    <p>
      <input
        type="button"
        value="Clear Cached Activities"
        v-on:click="$emit('clearCache')"
      />
    </p>
  </div>
</template>
